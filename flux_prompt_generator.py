...
DressColor = load_json_file("dresscolor.json")
Department = load_json_file("department.json")
Detail = load_json_file("detail.json")
FabricElasticity:  = load_json_file("fabricelasticity.json")
Fit = load_json_file("fit.json")
Hemline = load_json_file("hemline.json")
Material = load_json_file("material.json")
Neckline = load_json_file("neckline.json")
Pattern = load_json_file("pattern.json")
SleeveLength = load_json_file("sleevelenght.json")
Style = load_json_file("style.json")
Type = load_json_file("type.json")
Waistline = load_json_file("waistline.json")
